            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex space-x-8">
                        ...
                        <a href="#formation" className="text-gray-700 hover:text-gray-900 font-medium transition-colors">Formation</a>
            ...
            {isOpen && (
                <div className="md:hidden bg-white border-t">
                    <div className="px-2 pt-2 pb-3 space-y-1">
                        ...
                        <a href="#formation" className="block px-3 py-2 rounded-md text-gray-700 hover:bg-gray-100 font-medium">Formation</a>
